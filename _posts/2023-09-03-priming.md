...
However many people still choose to apply alodining. I think alodining internally makes sense for the reason of corrosion protection. First of
...
So if I want the full process and full experience, then the whole thing will go like this:
...
And if I don't need alodine, I don't need a dedicated acid bath as long as I use some self-etching primer product.

...
Since I built the DRDT-2 a few days ago, I have been wanting to build a stand for it. When the DRDT sits on the stand, I want the top of the tool to stay flush with my work bench.
...
The stand was pretty easy to put together. But as a side note, because I did not have a blueprint to follow, I needed to learn to 3D model the

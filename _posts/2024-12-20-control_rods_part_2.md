...
For almos this entire week, I am still tweaking the control tubes and shaving off materials here and there.
...
I discovered that the 3 channels holding the tube together are not perfectly parallel. So no matther what I do it wouldn't go frictionless. I temporarily connect the tubes and link rods all together, then tried to move them using the control stick. The force needed on the control stick was tiny. Aiden (my 10 months old) was even able to move the stick. So I think that's a good litmus test.
...
- Add edge proector so even the cable rubs it has some protection.
- Add some silican tape on the rudder cable itself, for the same reason.
...
_Channel widend on one side. I ended up widening both sides_
...
_Added edge protector and silican tape_

...
!(function () {
  ...
  const S = {
    ...
    off(e, t, n, i) {
      ...
      const [o, r, s] = x(t, n, i),
        ...
        f = t.startsWith('.');
      if (void 0 === r) {
        if (f) for (const n of Object.keys(l)) L(e, l, n, t.slice(1));
  ...
  function Ge(e) {
    var t,
      ...
      h = s.y,
      m = void 0 === h ? 0 : h,
      g = 'function' == typeof f ? f({ x: p, y: m }) : { x: p, y: m };
    (p = g.x), (m = g.y);
    ...
    if (c) {
      ...
      if (o === ne || ((o === Z || o === ee) && r === se))
        (y = te),
          (p -=
            (u && E === w && w.visualViewport ? w.visualViewport.width : E[x]) -
            i.width),
          (p *= l ? 1 : -1);
    }
    var A,
  ...
  function ht(e, t) {
    ...
    var n = t,
      ...
      y = e.rects.popper,
      _ = e.elements[h ? b : d],
      w = dt(Ae(_) ? _ : _.contextElement || $e(e.elements.popper), l, f, s),
      E = Me(e.elements.reference),
      O = pt({ reference: E, element: y, placement: o }),
      x = ft(Object.assign({}, y, O)),
      A = d === ce ? x : E,
      C = {
  ...
  var Et = {
    ...
    fn: function (e) {
      var t = e.state,
        ...
        h = n.tetherOffset,
        m = void 0 === h ? 0 : h,
        g = ht(t, { boundary: l, rootBoundary: c, padding: u, altBoundary: f }),
        v = Se(t.placement),
        b = Qe(t.placement),
        y = !b,
        _ = Re(v),
      ...
      if (E) {
        ...
        if (a) {
          var J,
            ...
            ce = se - g[oe],
            fe = -1 !== [Z, ne].indexOf(v),
            ue = null != (J = null == L ? void 0 : L[w]) ? J : 0,
            de = fe ? le : se - O[ae] - x[ae] - ue + C.altAxis,
            pe = fe ? se + O[ae] + x[ae] - ue - C.altAxis : ce,
            he =
              p && fe
                ? (function (e, t, n) {
                    var i = Ve(e, t, n);
        ...
        (('body' !== Oe(t) || at(a)) &&
          (c =
            (i = t) !== xe(i) && Ce(i)
              ...
              : rt(i)),
        Ce(t)
          ? (((f = Me(t, !0)).x += t.clientLeft), (f.y += t.clientTop))
          : a && (f.x = st(a))),
      {
              ...
              if (Ct(t, n)) {
                ...
                for (var i = 0; i < a.orderedModifiers.length; i++)
                  if (!0 !== a.reset) {
                    ...
                    'function' == typeof r &&
                      (a =
                        r({ state: a, options: l, name: u, instance: f }) || a);
                  } else (a.reset = !1), (i = -1);
              }
            }
          },
  ...
  class cn {
    static initBar() {
      new IntersectionObserver(
        ...
        { rootMargin: `-${Jt(cn, this, un)._}px 0px 0px 0px` }
      ).observe(nn),
        (fn._ = Jt(cn, this, !1));
    }
    ...
    static refresh() {
      Jt(cn, this, fn)._ && this.initComponents(),
  ...
  Zt(cn, 'options', {
    ...
    scrollSmooth: !1,
    collapseDepth: 4,
    headingsOffset: Jt((en = cn), en, un)._
  });
  Zt(
    class {
      static refresh() {
  ...
  Zt(Pn, 'resultVisible', !1),
    ...
    [...J].forEach((e) => {
      ...
      e.addEventListener('hide.bs.collapse', () => {
        n &&
          ((n.querySelector('.far.fa-folder-open').className =
            'far fa-folder fa-fw'),
          n.querySelector('.fas.fa-angle-down').classList.add('rotate'),
          n.classList.remove('hide-border-bottom'));
      }),
        e.addEventListener('show.bs.collapse', () => {
          n &&
            ((n.querySelector('.far.fa-folder').className =
              'far fa-folder-open fa-fw'),
            n.querySelector('.fas.fa-angle-down').classList.remove('rotate'),

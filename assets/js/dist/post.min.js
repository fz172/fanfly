...
!(function () {
  ...
  const n = 'transitionend',
    ...
    d = function (t) {
      ...
      return 'function' == typeof t ? t.call(...e) : n;
    },
    p = function (t, e) {
  ...
  const P = {
    ...
    getDataAttributes(t) {
      ...
      for (const i of n) {
        let n = i.replace(/^bs/, '');
        (n = n.charAt(0).toLowerCase() + n.slice(1)), (e[n] = k(t.dataset[i]));
      }
      return e;
    },
  ...
  class X extends M {
      ...
      if (
        (this._config.parent &&
          (t = this._getFirstLevelChildren(
            ...
            .map((t) => X.getOrCreateInstance(t, { toggle: !1 }))),
    ...
    hide() {
      if (this._isTransitioning || !this._isShown()) return;
      if (S.trigger(this._element, q).defaultPrevented) return;
    ...
    static jQueryInterface(t) {
      ...
      return (
        ...
        this.each(function () {
          const n = X.getOrCreateInstance(this, e);
          if ('string' == typeof t) {
  ...
  S.on(document, W, K, function (t) {
    ('A' === t.target.tagName ||
      (t.delegateTarget && 'A' === t.delegateTarget.tagName)) &&
      t.preventDefault();
    for (const t of I.getMultipleElementsFromSelector(this))
      X.getOrCreateInstance(t, { toggle: !1 }).toggle();
  }),
    f(X),
  ...
  function Ct(t) {
    return (
      ...
      (t instanceof At(t).ShadowRoot || t instanceof ShadowRoot)
    );
  }
  var Tt = {
    name: 'applyStyles',
  ...
  function Nt(t, e, n) {
    ...
    var s = (xt(t) ? At(t) : window).visualViewport,
      a = !Pt() && n,
  ...
  function Ht(t) {
    return 'html' === Et(t)
      ? t
      : t.assignedSlot || t.parentNode || (Ct(t) ? t.host : null) || $t(t);
  }
  function qt(t) {
    return Ot(t) && 'fixed' !== It(t).position ? t.offsetParent : null;
  }
  function zt(t) {
    for (var e = At(t), n = qt(t); n && Ft(n) && 'static' === It(n).position; )
      n = qt(n);
    return n &&
      ...
      : n ||
          (function (t) {
            ...
            if (/Trident/i.test(Dt()) && Ot(t) && 'fixed' === It(t).position)
              return null;
            var n = Ht(t);
            for (
              Ct(n) && (n = n.host);
              Ot(n) && ['html', 'body'].indexOf(Et(n)) < 0;
    ...
    fn: function (t) {
      ...
      if (r && s) {
        var u = (function (t, e) {
          ...
          E = Rt(y, w, _),
          A = l;
        n.modifiersData[i] = (((e = {})[A] = E), (e.centerOffset = E - w), e);
      }
    },
    effect: function (t) {
      var e = t.state,
  ...
  function re(t) {
    return Nt($t(t)).left + oe(t).scrollLeft;
  }
  function se(t) {
    var e = It(t),
      n = e.overflow,
    ...
    var o =
        'clippingParents' === e
          ? (function (t) {
              var e = le(Ht(t)),
                n =
                  ['absolute', 'fixed'].indexOf(It(t).position) >= 0 && Ot(t)
                    ? zt(t)
                    : t;
              return xt(n)
                ? e.filter(function (t) {
  ...
  function pe(t, e) {
    ...
    var n = e,
      ...
      m = n.padding,
      g = void 0 === m ? 0 : m,
      b = Vt('number' != typeof g ? g : Yt(g, it)),
      v = d === lt ? ct : lt,
      y = t.rects.popper,
      _ = t.elements[h ? v : d],
      w = fe(xt(_) ? _ : _.contextElement || $t(t.elements.popper), l, u, s),
      E = Nt(t.elements.reference),
      A = de({ reference: E, element: y, placement: o }),
      x = ce(Object.assign({}, y, A)),
      O = d === lt ? x : E,
      C = {
      ...
      if (E) {
        if (r) {
          var S,
            ...
            W = q[k],
            R = Rt(0, A[D], H[D]),
            V = y ? A[D] / 2 - B - R - z - C.mainAxis : I - R - z - C.mainAxis,
            Y = y ? -A[D] / 2 + B + R + W + C.mainAxis : F + R + W + C.mainAxis,
            U = e.elements.arrow && zt(e.elements.arrow),
            K = U ? ('y' === _ ? U.clientTop || 0 : U.clientLeft || 0) : 0,
            Q = null != (S = null == T ? void 0 : T[_]) ? S : 0,
            G = P + Y - Q,
            X = Rt(p ? jt(N, P + V - Q - K) : N, P, p ? St(M, G) : M);
          (E[_] = X), (L[_] = X - P);
        }
        if (a) {
          var nt,
            ...
            dt = ut ? lt : st - A[at] - x[at] - ft + C.altAxis,
            pt = ut ? st + A[at] + x[at] - ft - C.altAxis : ct,
            ht =
              p && ut
                ? (function (t, e, n) {
                    var i = Rt(t, e, n);
        ...
        (('body' !== Et(e) || se(a)) &&
          (c =
            (i = e) !== At(i) && Ot(i)
              ...
              : oe(i)),
        Ot(e)
          ? (((u = Nt(e, !0)).x += e.clientLeft), (u.y += e.clientTop))
          : a && (u.x = re(a))),
      {
  ...
  var Te = Ce(),
    Le = Ce({ defaultModifiers: [Zt, _e, Xt, Tt] }),
    Se = Ce({ defaultModifiers: [Zt, _e, Xt, Tt, ye, me, we, Ut, ve] }),
    je = Object.freeze({
      __proto__: null,
      afterMain: bt,
      afterRead: ht,
        ...
        ? (function (t, e, n) {
            ...
            for (const t of o) {
              ...
              const i = [].concat(...t.attributes),
                o = [].concat(e['*'] || [], e[n] || []);
              for (const e of i) Ne(e, o) || t.removeAttribute(e.nodeName);
            }
  ...
  const $e = new Set(['sanitize', 'allowList', 'sanitizeFn']),
    He = 'fade',
    qe = 'show',
    ze = '.tooltip-inner',
    We = '.modal',
  ...
  class Ge extends M {
    ...
    dispose() {
      clearTimeout(this._timeout),
        S.off(this._element.closest(We), Re, this._hideModalHandler),
    ...
    hide() {
      ...
      if (
        ...
        return;
      if (
        (this._getTipElement().classList.remove(qe),
        'ontouchstart' in document.documentElement)
      )
        for (const t of [].concat(...document.body.children))
          S.off(t, 'mouseover', a);
    ...
    _createTipElement(t) {
      ...
      return (
        e.setAttribute('id', n), this._isAnimated() && e.classList.add(He), e
      );
    }
    setContent(t) {
      (this._newContent = t),
    ...
    _isAnimated() {
      return (
        this._config.animation || (this.tip && this.tip.classList.contains(He))
      );
    }
    _isShown() {
      return this.tip && this.tip.classList.contains(qe);
    }
    _createPopper(t) {
    ...
    _resolvePossibleFunction(t) {
      return d(t, [this._element, this._element]);
    }
    _getPopperConfig(t) {
      const e = {
        placement: t,
    ...
    _setListeners() {
      ...
      (this._hideModalHandler = () => {
        ...
        S.on(this._element.closest(We), Re, this._hideModalHandler);
    }
    _fixTitle() {
    ...
    _getConfig(t) {
      ...
      for (const t of Object.keys(e)) $e.has(t) && delete e[t];
      return (
  ...
  f(Ge);
  const Xe = '.code-header>button',
    Je = 'timeout',
    Ze = 'data-title-succeed',
    tn = 'data-bs-original-title',
    en = 2e3;
  function nn(t) {
    if (t.hasAttribute(Je)) {
      let e = t.getAttribute(Je);
      if (Number(e) > Date.now()) return !0;
    }
    return !1;
  }
  function on(t) {
    t.setAttribute(Je, Date.now() + en);
  }
  function rn(t) {
    t.removeAttribute(Je);
  }
  function sn() {
    const t = document.querySelectorAll(Xe);
    if (0 === t.length) return;
    const e = new ClipboardJS(Xe, {
      target: (t) =>
        t.parentNode.nextElementSibling.querySelector('code .rouge-code')
    });
    [...t].map((t) => new Ge(t, { placement: 'left' })),
      e.on('success', (t) => {
        const e = t.trigger;
        (t.clearSelection(), nn(e)) ||
          (e.children[0].setAttribute('class', 'fas fa-check'),
          (function (t) {
            const e = t.getAttribute(Ze);
            t.setAttribute(tn, e), Ge.getInstance(t).show();
          })(e),
          on(e),
          setTimeout(() => {
            !(function (t) {
              Ge.getInstance(t).hide(), t.removeAttribute(tn);
            })(e),
              (function (t) {
  ...
  function dn() {
    this.complete &&
      (this.hasAttribute(ln) ? fn.call(this, un) : fn.call(this, cn));
  }
  function pn() {
    const t = this.getAttribute(an);
    this.setAttribute('src', encodeURI(t)), this.removeAttribute(an);
  }
  const hn = '.popup:not(.dark)',
    mn = '.popup:not(.light)';
  let gn = hn;
  class bn {
  ...
  const wn = document.getElementById('toc-bar'),
    ...
    On = document.getElementById('toc-popup-close'),
    Cn = 'overflow-hidden',
    Tn = 'closing';
  class Ln {
    static initBar() {
      new IntersectionObserver(
        (t) => {
          t.forEach((t) => {
            wn.classList.toggle('invisible', t.isIntersecting);
          });
        },
        { rootMargin: `-${vn(Ln, this, jn)._}px 0px 0px 0px` }
      ).observe(En),
        (Sn._ = vn(Ln, this, !1));
    }
    ...
    static hidePopup() {
      xn.toggleAttribute(Tn),
        xn.addEventListener(
          'animationend',
          () => {
            xn.toggleAttribute(Tn), xn.close();
          },
          { once: !0 }
        ),
        this.lockScroll(!1);
  ...
  yn(Ln, 'options', {
    ...
    scrollSmooth: !1,
    collapseDepth: 4,
    headingsOffset: vn((_n = Ln), _n, jn)._
  });
  class kn {
    static refresh() {
      tocbot.refresh(this.options);
  ...
  const Dn = matchMedia('(min-width: 1200px)');
  function Pn(t) {
    t.matches ? (Ln.popupOpened && Ln.hidePopup(), kn.refresh()) : Ln.refresh();
  }
  const Nn = 'mermaid',
    Mn = Theme.getThemeMapper('default', 'dark');
  function Bn(t) {
    if (t.source === window && t.data && t.data.id === Theme.ID) {
      [...document.getElementsByClassName(Nn)].forEach((t) => {
        const e = t.previousSibling.children.item(0).textContent;
        (t.textContent = e), t.removeAttribute('data-processed');
      });
      const t = Mn[Theme.visualState];
      mermaid.initialize({ theme: t }), mermaid.init(null, `.${Nn}`);
    }
  }
  function In(t) {
  ...
  const Fn = document.getElementById('mode-toggle');
  const $n = document.getElementById('sidebar'),
    Hn = document.getElementById('sidebar-trigger'),
    qn = document.getElementById('mask');
  class zn {
    static toggle() {
      (Wn._ = vn(zn, this, !vn(zn, this, Wn)._)),
        document.body.toggleAttribute('sidebar-display', vn(zn, this, Wn)._),
        $n.classList.toggle('z-2', vn(zn, this, Wn)._),
        qn.classList.toggle('d-none', !vn(zn, this, Wn)._);
    }
  }
  var Wn = { _: !1 };
  const Rn = document.getElementById('sidebar-trigger'),
    Vn = document.getElementById('search-trigger'),
    Yn = document.getElementById('search-cancel'),
    Un = document.querySelectorAll('#main-wrapper>.container>.row'),
    Kn = document.getElementById('topbar-title'),
    Qn = document.getElementById('search'),
    Gn = document.getElementById('search-result-wrapper'),
    Xn = document.getElementById('search-results'),
    Jn = document.getElementById('search-input'),
    Zn = document.getElementById('search-hints'),
    ti = 'd-block',
    ei = 'd-none',
    ni = 'input-focus',
    ii = 'd-flex';
  class oi {
    ...
    static off() {
      Yn.classList.remove(ti),
        Qn.classList.remove(ii),
        Rn.classList.remove(ei),
        Kn.classList.remove(ei),
        Vn.classList.remove(ei);
    }
  }
  class ri {
    static on() {
      this.resultVisible ||
        (Gn.classList.remove(ei),
        Un.forEach((t) => {
          t.classList.add(ei);
        }),
    ...
    static off() {
      this.resultVisible &&
        ((Xn.innerHTML = ''),
        Zn.classList.contains(ei) && Zn.classList.remove(ei),
        Gn.classList.add(ei),
        Un.forEach((t) => {
  ...
  function si() {
    return Yn.classList.contains(ti);
  }
  yn(ri, 'resultVisible', !1),
    (function () {
      const t = document.querySelectorAll('article img');
      if (0 === t.length) return;
      t.forEach((t) => {
        t.addEventListener('load', dn);
      }),
        document
          .querySelectorAll('article img[loading="lazy"]')
          .forEach((t) => {
            t.complete && fn.call(t, cn);
          });
      const e = document.querySelectorAll(`article img[${ln}="true"]`);
      e.length &&
        e.forEach((t) => {
          pn.call(t);
        });
    ...
    (function () {
      ...
      Theme.visualState === Theme.DARK && (gn = mn);
      let e = GLightbox({ selector: `${gn}` });
      if (t && Theme.switchable) {
        ...
        window.addEventListener('message', (n) => {
          n.source === window &&
            ...
            (function (t, e) {
              (gn = gn === hn ? mn : hn),
                null === e && (e = GLightbox({ selector: `${gn}` })),
                ([t, e] = [e, t]);
            })(e, t);
        });
      }
    })(),
    (Hn.onclick = qn.onclick = () => zn.toggle()),
    dayjs.locale(bn.locale),
    dayjs.extend(window.dayjs_plugin_localizedFormat),
    document.querySelectorAll(`[${bn.attrTimestamp}]`).forEach((t) => {
      const e = dayjs.unix(bn.getTimestamp(t)),
        n = e.format(bn.getDateFormat(t));
      if (
        ((t.textContent = n),
        t.removeAttribute(bn.attrTimestamp),
        t.removeAttribute(bn.attrDateFormat),
          ...
          nn(e) ||
            navigator.clipboard.writeText(window.location.href).then(() => {
              const t = e.getAttribute(tn),
                n = e.getAttribute(Ze);
              e.setAttribute(tn, n),
                Ge.getInstance(e).show(),
                on(e),
                setTimeout(() => {
                  e.setAttribute(tn, t), rn(e);
                }, en);
            });
        }),
        t.addEventListener('mouseleave', (t) => {
          Ge.getInstance(t.target).hide();
        }));
    })(),
    Vn.addEventListener('click', () => {
      oi.on(), ri.on(), Jn.focus();
    }),
    Yn.addEventListener('click', () => {
      oi.off(), ri.off();
    }),
    Jn.addEventListener('focus', () => {
      Qn.classList.add(ni);
    }),
    Jn.addEventListener('focusout', () => {
      Qn.classList.remove(ni);
    }),
    Jn.addEventListener('input', () => {
      '' === Jn.value
        ? si()
          ? Zn.classList.remove(ei)
          : ri.off()
        : (ri.on(), si() && Zn.classList.add(ei));
    }),
    (function () {
      if (
        ...
        return;
      let t = { theme: Mn[Theme.visualState] };
      [...document.getElementsByClassName('language-mermaid')].forEach(In),
        mermaid.initialize(t),
        Theme.switchable && window.addEventListener('message', Bn);
    })(),
    Fn &&

...
!(function () {
  ...
  const n = 'transitionend',
    ...
    d = function (e) {
      ...
      return 'function' == typeof e ? e.call(...t) : n;
    },
    p = function (e, t) {
  ...
  const P = {
    ...
    getDataAttributes(e) {
      ...
      for (const i of n) {
        let n = i.replace(/^bs/, '');
        (n = n.charAt(0).toLowerCase() + n.slice(1)), (t[n] = k(e.dataset[i]));
      }
      return t;
    },
  ...
  var J = 'top',
    ...
    fe = [].concat(ie, [ne]).reduce(function (e, t) {
  ...
  function Ce(e) {
    return (
      ...
      (e instanceof Oe(e).ShadowRoot || e instanceof ShadowRoot)
    );
  }
  var Le = {
    name: 'applyStyles',
  ...
  function Me(e, t, n) {
    ...
    var s = (xe(e) ? Oe(e) : window).visualViewport,
      a = !Pe() && n,
  ...
  function ze(e) {
    return Ae(e) && 'fixed' !== Ie(e).position ? e.offsetParent : null;
  }
  function We(e) {
    for (var t = Oe(e), n = ze(e); n && Fe(n) && 'static' === Ie(n).position; )
      n = ze(n);
    return n &&
      ...
      : n ||
          (function (e) {
            ...
            if (/Trident/i.test(De()) && Ae(e) && 'fixed' === Ie(e).position)
              return null;
            var n = $e(e);
            for (
              Ce(n) && (n = n.host);
              Ae(n) && ['html', 'body'].indexOf(Ee(n)) < 0;
  ...
  function rt(e) {
    return Me(He(e)).left + ot(e).scrollLeft;
  }
  function st(e) {
    var t = Ie(e),
      n = t.overflow,
    ...
    var o =
        'clippingParents' === t
          ? (function (e) {
              var t = lt($e(e)),
                n =
                  ['absolute', 'fixed'].indexOf(Ie(e).position) >= 0 && Ae(e)
                    ? We(e)
                    : e;
              return xe(n)
                ? t.filter(function (e) {
                    return xe(e) && Be(e, n) && 'body' !== Ee(e);
                  })
                : [];
            })(e)
          : [].concat(t),
  ...
  function pt(e, t) {
    ...
    var n = t,
      ...
      g = n.padding,
      m = void 0 === g ? 0 : g,
      v = Ve('number' != typeof m ? m : Ye(m, ie)),
      b = d === le ? ce : le,
      y = e.rects.popper,
      _ = e.elements[h ? b : d],
      w = ft(xe(_) ? _ : _.contextElement || He(e.elements.popper), l, u, s),
      E = Me(e.elements.reference),
      O = dt({ reference: E, element: y, placement: o }),
      x = ct(Object.assign({}, y, O)),
      A = d === le ? x : E,
      C = {
  ...
  var wt = {
    ...
    fn: function (e) {
      var t = e.state,
        ...
        h = n.tetherOffset,
        g = void 0 === h ? 0 : h,
        m = pt(t, { boundary: l, rootBoundary: c, padding: f, altBoundary: u }),
        v = Te(t.placement),
        b = Ke(t.placement),
        y = !b,
        _ = Re(v),
      ...
      if (E) {
        if (r) {
          var S,
            ...
            R = z[k],
            q = qe(0, O[D], $[D]),
            V = y ? O[D] / 2 - B - q - W - C.mainAxis : I - q - W - C.mainAxis,
            Y = y ? -O[D] / 2 + B + q + R + C.mainAxis : F + q + R + C.mainAxis,
            U = t.elements.arrow && We(t.elements.arrow),
            K = U ? ('y' === _ ? U.clientTop || 0 : U.clientLeft || 0) : 0,
            Q = null != (S = null == L ? void 0 : L[_]) ? S : 0,
            X = P + Y - Q,
            G = qe(p ? je(M, P + V - Q - K) : M, P, p ? Se(N, X) : N);
          (E[_] = G), (T[_] = G - P);
        }
        if (a) {
          var ne,
            ...
            ce = se - m[re],
            ue = -1 !== [J, te].indexOf(v),
            fe = null != (ne = null == L ? void 0 : L[w]) ? ne : 0,
        ...
        u = {
          ...
          forceUpdate: function () {
            if (!c) {
              ...
              if (At(t, n)) {
                (a.rects = {
                  reference: Et(t, We(n), 'fixed' === a.options.strategy),
                  popper: Ne(n)
                }),
                  (a.reset = !1),
  ...
  var Lt = Ct(),
    Tt = Ct({ defaultModifiers: [Ze, _t, Ge, Le] }),
    St = Ct({ defaultModifiers: [Ze, _t, Ge, Le, yt, gt, wt, Ue, bt] }),
    jt = Object.freeze({
      __proto__: null,
      afterMain: ve,
      afterRead: he,
  ...
  const kt = {
    ...
    Pt = /^(?!javascript:)(?:[a-z0-9+.-]+:|[^&:/?#]*(?:[/?#]|$))/i,
    Mt = (e, t) => {
      const n = e.nodeName.toLowerCase();
      return t.includes(n)
        ? !Dt.has(n) || Boolean(Pt.test(e.nodeValue))
  ...
  class Xt extends N {
    ...
    dispose() {
      clearTimeout(this._timeout),
        S.off(this._element.closest(Rt), qt, this._hideModalHandler),
    ...
    hide() {
      ...
      if (
        ...
        return;
      if (
        (this._getTipElement().classList.remove(zt),
        'ontouchstart' in document.documentElement)
      )
        for (const e of [].concat(...document.body.children))
          S.off(e, 'mouseover', a);
    ...
    _createTipElement(e) {
      ...
      return (
        t.setAttribute('id', n), this._isAnimated() && t.classList.add($t), t
      );
    }
    setContent(e) {
      (this._newContent = e),
    ...
    _isAnimated() {
      return (
        this._config.animation || (this.tip && this.tip.classList.contains($t))
      );
    }
    _isShown() {
      return this.tip && this.tip.classList.contains(zt);
    }
    _createPopper(e) {
    ...
    _getPopperConfig(e) {
      ...
      return { ...t, ...d(this._config.popperConfig, [void 0, t]) };
    }
    _setListeners() {
      ...
      for (const t of e)
        if ('click' === t)
          ...
          S.on(this._element, e, this._config.selector, (e) => {
            ...
            (t._activeTrigger['focusin' === e.type ? Yt : Vt] = !0), t._enter();
          }),
            S.on(this._element, n, this._config.selector, (e) => {
              const t = this._initializeOnDelegatedTarget(e);
              (t._activeTrigger['focusout' === e.type ? Yt : Vt] =
      ...
      (this._hideModalHandler = () => {
        ...
        S.on(this._element.closest(Rt), qt, this._hideModalHandler);
    }
    _fixTitle() {
  ...
  const en = document.getElementById('toc-bar'),
    tn = document.getElementById('toc-solo-trigger'),
    nn = document.getElementsByClassName('toc-trigger'),
    on = document.getElementById('toc-popup'),
    rn = document.getElementById('toc-popup-close'),
    sn = 'overflow-hidden',
    an = 'closing';
  class ln {
    static initBar() {
      new IntersectionObserver(
        ...
        { rootMargin: `-${Gt(ln, this, un)._}px 0px 0px 0px` }
      ).observe(tn),
        (cn._ = Gt(ln, this, !1));
    }
    ...
    static refresh() {
      Gt(ln, this, cn)._ && this.initComponents(),
    ...
    static showPopup() {
      this.lockScroll(!0), on.showModal();
      on.querySelector('li.is-active-li').scrollIntoView({ block: 'center' });
    }
    static hidePopup() {
      on.toggleAttribute(an),
        on.addEventListener(
          'animationend',
          () => {
            on.toggleAttribute(an), on.close();
          },
          { once: !0 }
        ),
        this.lockScroll(!1);
    ...
    static lockScroll(e) {
      document.documentElement.classList.toggle(sn, e),
        document.body.classList.toggle(sn, e);
    }
    static clickBackdrop(e) {
      if (on.hasAttribute(an)) return;
    ...
    static initComponents() {
      this.initBar(),
        ...
        (on.onclick = (e) => this.clickBackdrop(e)),
        (rn.onclick = () => this.hidePopup()),
        (on.oncancel = (e) => {
  ...
  Jt(ln, 'options', {
    ...
    scrollSmooth: !1,
    collapseDepth: 4,
    headingsOffset: Gt((Zt = ln), Zt, un)._
  });
  Jt(
    class {
      static refresh() {
  ...
  const dn = document.getElementById('sidebar'),
    pn = document.getElementById('sidebar-trigger'),
    hn = document.getElementById('mask');
  class gn {
    static toggle() {
      (mn._ = Gt(gn, this, !Gt(gn, this, mn)._)),
        document.body.toggleAttribute('sidebar-display', Gt(gn, this, mn)._),
        dn.classList.toggle('z-2', Gt(gn, this, mn)._),
        hn.classList.toggle('d-none', !Gt(gn, this, mn)._);
    }
  }
  var mn = { _: !1 };
  const vn = document.getElementById('sidebar-trigger'),
    bn = document.getElementById('search-trigger'),
    yn = document.getElementById('search-cancel'),
    _n = document.querySelectorAll('#main-wrapper>.container>.row'),
    wn = document.getElementById('topbar-title'),
    En = document.getElementById('search'),
    On = document.getElementById('search-result-wrapper'),
    xn = document.getElementById('search-results'),
    An = document.getElementById('search-input'),
    Cn = document.getElementById('search-hints'),
    Ln = 'd-block',
    Tn = 'd-none',
    Sn = 'input-focus',
    jn = 'd-flex';
  class kn {
    ...
    static off() {
      yn.classList.remove(Ln),
        En.classList.remove(jn),
        vn.classList.remove(Tn),
        wn.classList.remove(Tn),
        bn.classList.remove(Tn);
    }
  }
  class Dn {
    static on() {
      this.resultVisible ||
        (On.classList.remove(Tn),
        _n.forEach((e) => {
          e.classList.add(Tn);
        }),
    ...
    static off() {
      this.resultVisible &&
        ((xn.innerHTML = ''),
        Cn.classList.contains(Tn) && Cn.classList.remove(Tn),
        On.classList.add(Tn),
        _n.forEach((e) => {
  ...
  function Pn() {
    return yn.classList.contains(Ln);
  }
  Jt(Dn, 'resultVisible', !1),
    (pn.onclick = hn.onclick = () => gn.toggle()),
    bn.addEventListener('click', () => {
      kn.on(), Dn.on(), An.focus();
    }),
    yn.addEventListener('click', () => {
      kn.off(), Dn.off();
    }),
    An.addEventListener('focus', () => {
      En.classList.add(Sn);
    }),
    An.addEventListener('focusout', () => {
      En.classList.remove(Sn);
    }),
    An.addEventListener('input', () => {
      '' === An.value
        ? Pn()
          ? Cn.classList.remove(Tn)
          : Dn.off()
        : (Dn.on(), Pn() && Cn.classList.add(Tn));
    }),
    fn &&
